...
const Report = () => {
  ...
  const [selectedVisitorReportType, setSelectedVisitorReportType] =
    useState("");
  ...
  const handleView = async () => {
    ...
    if (reportType === "configuration") {
      if (selectedGadget === "reader")
        fetchurl = `${url}/reports/readers?download=false`;
      if (selectedGadget === "adam")
        fetchurl = `${url}/reports/adam?download=false`;
      if (selectedGadget === "zone")
        fetchurl = `${url}/reports/zone?download=false`;
      if (selectedGadget === "key")
        fetchurl = `${url}/reports/key?download=false`;
    }
